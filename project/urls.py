...
from .views import Listprojectview,Createprojectview,CreateTask,ProjectsTaskView,DashboardAnalyticsView,UpdateTaskStatusView,AssignTaskView,AssignableUsersView
